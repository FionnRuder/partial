...
const api = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$query$2f$react$2f$rtk$2d$query$2d$react$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createApi"])({
    baseQuery: async (args, api, extraOptions)=>{
        ...
        if (result.error && 'status' in result.error && result.error.status === 401) {
            ...
            if ((errorData === null || errorData === void 0 ? void 0 : errorData.requiresLogin) || (errorData === null || errorData === void 0 ? void 0 : (_errorData_message = errorData.message) === null || _errorData_message === void 0 ? void 0 : _errorData_message.includes('Session expired')) || (errorData === null || errorData === void 0 ? void 0 : (_errorData_message1 = errorData.message) === null || _errorData_message1 === void 0 ? void 0 : _errorData_message1.includes('Authentication required'))) {
                // Clear local storage
                if ("TURBOPACK compile-time truthy", 1) {
    ...
    endpoints: (build)=>({
            ...
            getWorkItemById: build.query({
                query: (workItemId)=>"workItems/".concat(workItemId),
            ...
            getWorkItemsByProgram: build.query({
                query: (param)=>{
                    let { programId } = param;
                    return "workItems?programId=".concat(programId);
                },
                providesTags: (result)=>result ? [
                        ...result.map((param)=>{
                            let { id } = param;
            ...
            getWorkItemsByPart: build.query({
                query: (param)=>{
                    let { partId, includeChildren } = param;
                    ...
                    return "workItems?".concat(params.toString());
                },
                providesTags: (result)=>result ? [
                        ...result.map((param)=>{
                            let { id } = param;
            ...
            getWorkItemsByUser: build.query({
                query: (id)=>"workItems/user/".concat(id),
                providesTags: (result)=>result ? [
                        ...result.map((param)=>{
                            let { id } = param;
                            return {
            ...
            updateWorkItemStatus: build.mutation({
                query: (param)=>{
                    let { workItemId, status } = param;
                    return {
                        url: "workItems/".concat(workItemId, "/status"),
                        method: "PATCH",
                        body: {
                            status
                        }
            ...
            editWorkItem: build.mutation({
                query: (param)=>{
                    let { workItemId, updates } = param;
                    return {
                        url: "workItems/".concat(workItemId),
                        method: "PATCH",
                        body: updates
                    };
                },
            ...
            getCommentsByWorkItem: build.query({
                query: (workItemId)=>"workItems/".concat(workItemId, "/comments"),
            ...
            createComment: build.mutation({
                query: (param)=>{
                    let { workItemId, text, commenterUserId } = param;
                    return {
                        url: "workItems/".concat(workItemId, "/comments"),
                        method: "POST",
                        body: {
                            text,
                            commenterUserId
            ...
            updateComment: build.mutation({
                query: (param)=>{
                    let { workItemId, commentId, text, requesterUserId } = param;
                    return {
                        url: "workItems/".concat(workItemId, "/comments/").concat(commentId),
                        method: "PATCH",
                        body: {
                            text,
                            requesterUserId
                ...
                invalidatesTags: (result, error, param)=>{
                    let { workItemId, commentId } = param;
                    return [
                        {
                            type: "Comments",
                            id: commentId
            ...
            deleteComment: build.mutation({
                query: (param)=>{
                    let { workItemId, commentId, requesterUserId } = param;
                    return {
                        url: "workItems/".concat(workItemId, "/comments/").concat(commentId),
                        method: "DELETE",
                        body: {
            ...
            getStatusLogsByWorkItem: build.query({
                query: (workItemId)=>"workItems/".concat(workItemId, "/statusLogs"),
                providesTags: (result, error, workItemId)=>result ? [
                        ...result.map((param)=>{
                            let { id } = param;
                            return {
            ...
            createStatusLog: build.mutation({
                query: (param)=>{
                    let { workItemId, status, engineerUserId } = param;
                    return {
                        url: "workItems/".concat(workItemId, "/statusLogs"),
                        method: "POST",
                        body: {
                            status,
                            engineerUserId
            ...
            updateStatusLog: build.mutation({
                query: (param)=>{
                    let { workItemId, statusLogId, status, requesterUserId } = param;
                    return {
                        url: "workItems/".concat(workItemId, "/statusLogs/").concat(statusLogId),
                        method: "PATCH",
                        body: {
                            status,
                            requesterUserId
                ...
                invalidatesTags: (result, error, param)=>{
                    let { workItemId, statusLogId } = param;
                    return [
                        {
                            type: "StatusLogs",
                            id: statusLogId
            ...
            deleteStatusLog: build.mutation({
                query: (param)=>{
                    let { workItemId, statusLogId, requesterUserId } = param;
                    return {
                        url: "workItems/".concat(workItemId, "/statusLogs/").concat(statusLogId),
                        method: "DELETE",
                        body: {
            ...
            getAttachmentsByWorkItem: build.query({
                query: (workItemId)=>"workItems/".concat(workItemId, "/attachments"),
                providesTags: (result, error, workItemId)=>result ? [
                        ...result.map((param)=>{
                            let { id } = param;
                            return {
            ...
            createAttachment: build.mutation({
                query: (param)=>{
                    let { workItemId, fileUrl, fileName, uploadedByUserId } = param;
                    return {
                        url: "workItems/".concat(workItemId, "/attachments"),
                        method: "POST",
                        body: {
                            fileUrl,
                            fileName,
            ...
            updateAttachment: build.mutation({
                query: (param)=>{
                    let { workItemId, attachmentId, fileName, fileUrl, requesterUserId } = param;
                    return {
                        url: "workItems/".concat(workItemId, "/attachments/").concat(attachmentId),
                        method: "PATCH",
                        body: {
                            fileName,
                            fileUrl,
                ...
                invalidatesTags: (result, error, param)=>{
                    let { workItemId, attachmentId } = param;
                    return [
                        {
                            type: "Attachments",
                            id: attachmentId
            ...
            deleteAttachment: build.mutation({
                query: (param)=>{
                    let { workItemId, attachmentId, requesterUserId } = param;
                    return {
                        url: "workItems/".concat(workItemId, "/attachments/").concat(attachmentId),
                        method: "DELETE",
                        body: {
            ...
            getMilestonesByProgram: build.query({
                query: (param)=>{
                    let { programId } = param;
                    return "milestones?programId=".concat(programId);
                },
                providesTags: [
                    "Milestones"
                ]
            ...
            editMilestone: build.mutation({
                query: (param)=>{
                    let { milestoneId, updates } = param;
                    return {
                        url: "milestones/".concat(milestoneId),
                        method: "PATCH",
                        body: updates
                    };
                },
                invalidatesTags: (result, error, param)=>{
                    let { milestoneId } = param;
                    return [
                        {
                            type: "Milestones",
                            id: milestoneId
            ...
            getPartsByProgram: build.query({
                query: (param)=>{
                    let { programId } = param;
                    return "parts?programId=".concat(programId);
                },
                providesTags: (result)=>result ? [
                        ...result.map((param)=>{
                            let { id } = param;
            ...
            editPart: build.mutation({
                query: (param)=>{
                    let { partId, updates } = param;
                    return {
                        url: "parts/".concat(partId),
                        method: "PATCH",
                        body: updates
                    };
                },
            ...
            editProgram: build.mutation({
                query: (param)=>{
                    let { programId, updates } = param;
                    return {
                        url: "programs/".concat(programId),
                        method: "PATCH",
                        body: updates
                    };
                },
            ...
            editTeam: build.mutation({
                query: (param)=>{
                    let { teamId, updates } = param;
                    return {
                        url: "teams/".concat(teamId),
                        method: "PATCH",
                        body: updates
                    };
                },
            ...
            getEmailPreferences: build.query({
                query: (id)=>"users/".concat(id, "/email-preferences"),
                providesTags: (result, error, id)=>[
                        {
                            type: "Users",
                            id
            ...
            updateEmailPreferences: build.mutation({
                query: (param)=>{
                    let { id, preferences } = param;
                    return {
                        url: "users/".concat(id, "/email-preferences"),
                        method: "PUT",
                        body: preferences
                    };
                },
            ...
            validateInvitation: build.query({
                query: (token)=>"invitations/validate/".concat(token)
            }),
            ...
            revokeInvitation: build.mutation({
                query: (invitationId)=>({
                        url: "invitations/".concat(invitationId),
                        method: "DELETE"
                    }),
                invalidatesTags: [
                    "Invitations"
            ...
            updateDeliverableType: build.mutation({
                query: (param)=>{
                    let { typeId, updates } = param;
                    return {
                        url: "deliverableTypes/".concat(typeId),
                        method: "PATCH",
                        body: updates
                    };
                },
            ...
            getFeedback: build.query({
                query: (params)=>{
                    ...
                    if (params === null || params === void 0 ? void 0 : params.type) searchParams.append("type", params.type);
                    if (params === null || params === void 0 ? void 0 : params.priority) searchParams.append("priority", params.priority);
                    const queryString = searchParams.toString();
                    return "feedback".concat(queryString ? "?".concat(queryString) : "");
                },
                providesTags: [
                    "Feedback"
                ]
            ...
            /* ---------- AUDIT LOGS ---------- */ getAuditLogs: build.query({
                query: (params)=>{
                    ...
                    return "auditLogs?".concat(queryParams.toString());
                },
                providesTags: [
                    "AuditLogs"
                ]
            ...
            getEntityAuditLogs: build.query({
                query: (param)=>{
                    let { entityType, entityId } = param;
                    return "auditLogs/entity/".concat(entityType, "/").concat(entityId);
                },
                providesTags: [
                    "AuditLogs"
                ]
            ...
            getAuditLogStats: build.query({
                query: (params)=>{
                    ...
                    if (params.startDate) queryParams.append("startDate", params.startDate);
                    if (params.endDate) queryParams.append("endDate", params.endDate);
                    return "auditLogs/stats?".concat(queryParams.toString());
                },
                providesTags: [
                    "AuditLogs"
                ]
...
function StoreProvider(param) {
    ...
    const [persistor, setPersistor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StoreProvider.useEffect": ()=>{
            ...
            if (storeRef.current && !persistor) {
                setPersistor((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$redux$2d$persist$2f$es$2f$persistStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__persistStore$3e$__["persistStore"])(storeRef.current));
            }
        }
    }["StoreProvider.useEffect"], [
        persistor
...
_s1(StoreProvider, "RCX5SeLM6ElelWHKCeDqRZmQ7P8=");
_c = StoreProvider;
var _c;
...
"[project]/src/lib/better-auth-client.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/betterAuthService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$better$2d$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/better-auth-client.ts [app-client] (ecmascript)");
;
;
class BetterAuthService {
    async initializeFromSession() {
        try {
            var _session_data;
            const session = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$better$2d$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authClient"].getSession();
    ...
    async fetchUserFromBackend(betterAuthUserId) {
        ...
        try {
            const response = await fetch("".concat(apiBaseUrl, "/users/").concat(betterAuthUserId), {
                method: "GET",
                credentials: "include"
            });
            if (response.ok) {
                var _userData_organization;
                ...
                const user = {
                    ...
                    organizationName: ((_userData_organization = userData.organization) === null || _userData_organization === void 0 ? void 0 : _userData_organization.name) || undefined
                };
    ...
    async signUp(data) {
        ...
        const { data: signUpData, error: signUpError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$better$2d$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authClient"].signUp.email({
            email: data.email,
        ...
        const user = {
            ...
            organizationId: 0,
            username: ((_signUpData_user_name = signUpData.user.name) === null || _signUpData_user_name === void 0 ? void 0 : _signUpData_user_name.split(' ')[0]) || signUpData.user.email.split('@')[0],
    ...
    async signIn(data) {
        ...
        const { data: signInData, error: signInError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$better$2d$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authClient"].signIn.email({
            email: data.email,
            password: data.password
        });
        if (signInError) {
    ...
    async signOut() {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$better$2d$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authClient"].signOut();
        // Clear local state
    ...
    async getCurrentUser() {
        ...
        const { data: session, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$better$2d$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authClient"].getSession();
    ...
    async updateUserProfile(updates) {
        ...
        const apiBaseUrl = ("TURBOPACK compile-time value", "http://localhost:8000") || "http://localhost:8000";
        try {
            const response = await fetch("".concat(apiBaseUrl, "/users/").concat(this.currentUser.id), {
                method: "PUT",
                headers: {
            ...
            if (response.ok) {
                ...
                const user = {
                    ...
                    organizationName: ((_updatedUser_organization = updatedUser.organization) === null || _updatedUser_organization === void 0 ? void 0 : _updatedUser_organization.name) || undefined
                };
                this.currentUser = user;
                this.notifyListeners();
                return user;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@swc/helpers/esm/_define_property.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$betterAuthService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/betterAuthService.ts [app-client] (ecmascript)");
;
;
class MockAuthService {
        ...
        if ("TURBOPACK compile-time truthy", 1) {
            ...
            if (stored) {
                try {
                    ...
                    var _parsed_organizationId;
                    this.currentUser = {
                        ...parsed,
                        organizationId: (_parsed_organizationId = parsed === null || parsed === void 0 ? void 0 : parsed.organizationId) !== null && _parsed_organizationId !== void 0 ? _parsed_organizationId : 1
                    };
                } catch (error) {
    ...
    async signUp(data) {
        ...
        try {
            ...
            const response = await fetch("".concat(apiBaseUrl, "/onboarding/signup"), {
                method: 'POST',
                headers,
                credentials: 'include',
                body: JSON.stringify({
            ...
            if (response.ok) {
                ...
                if (!((_result_user = result.user) === null || _result_user === void 0 ? void 0 : _result_user.id)) {
        ...
        if ("TURBOPACK compile-time truthy", 1) {
            ...
            if (storedUser) {
                ...
                if (existingUser.email === data.email) {
                    var _existingUser_organizationId;
                    const normalizedUser = {
                        ...existingUser,
                        organizationId: (_existingUser_organizationId = existingUser === null || existingUser === void 0 ? void 0 : existingUser.organizationId) !== null && _existingUser_organizationId !== void 0 ? _existingUser_organizationId : 1
                    };
    ...
    async signOut() {
        ...
        const apiBaseUrl = ("TURBOPACK compile-time value", "http://localhost:8000") || 'http://localhost:8000';
        window.location.href = "".concat(apiBaseUrl, "/auth/logout");
    }
    async refreshTokens() {
        // Mock implementation
        return {
            ...
            if (response.ok) {
                ...
                if (data.isAuthenticated && data.userExistsInDb && data.user) {
                    ...
                    const user = {
                        ...
                        organizationName: ((_data_organization = data.organization) === null || _data_organization === void 0 ? void 0 : _data_organization.name) || undefined
                    };
                    this.currentUser = user;
                    this.saveToStorage();
                    this.notifyListeners();
    ...
    async updateUserProfile(updates) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const updatedUser = await response.json();
                var _updatedUser_organizationId;
                const mergedUser = {
                    ...baseUser,
                    ...updatedUser,
                    id: baseUser.id,
                    organizationId: (_updatedUser_organizationId = updatedUser === null || updatedUser === void 0 ? void 0 : updatedUser.organizationId) !== null && _updatedUser_organizationId !== void 0 ? _updatedUser_organizationId : baseUser.organizationId
                };
...
function createAuthService() {
    ...
    return new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$betterAuthService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BetterAuthService"]();
}
const authService = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$betterAuthService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BetterAuthService"]();
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function AuthProvider(param) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const unsubscribe = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].onAuthStateChange({
    ...
    const signUp = async (data)=>{
        setIsLoading(true);
        try {
            const newUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].signUp(data);
    ...
    const signIn = async (data)=>{
        setIsLoading(true);
        try {
            const signedInUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].signIn(data);
    ...
    const signOut = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sentry$2f$core$2f$build$2f$esm$2f$exports$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setUser"](null);
        } catch (error) {
    ...
    const updateProfile = async (updates)=>{
        ...
        try {
            var _updates_profilePictureUrl;
            const mergedUpdates = {
                ...updates,
                profilePictureUrl: sanitizeProfilePictureUrl((_updates_profilePictureUrl = updates.profilePictureUrl) !== null && _updates_profilePictureUrl !== void 0 ? _updates_profilePictureUrl : undefined)
            };
            const updatedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].updateUserProfile(mergedUpdates);
    ...
    const refreshTokens = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authService"].refreshTokens();
        } catch (error) {
...
_s2(useAuthState, "Z8N3xU3gK+7xFIxevnSjK9d1+jo=", false, function() {
    return [
        useAuth
    ];
});
...
_s3(useAuthActions, "xmGDwSzDck7db9eauZ+/SuqQrFc=", false, function() {
    return [
        useAuth
    ];
});
function ProtectedRoute(param) {
    let { children, fallback, requireRole } = param;
    _s4();
    const { user, isLoading, isAuthenticated } = useAuth();
    if (isLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s4(ProtectedRoute, "Z8N3xU3gK+7xFIxevnSjK9d1+jo=", false, function() {
    return [
        useAuth
    ];
});
...
function useRoleAccess() {
    ...
    const isEngineer = ()=>{
        return (user === null || user === void 0 ? void 0 : user.role) === 'Engineer' || (user === null || user === void 0 ? void 0 : user.role) === 'Design Engineer' || (user === null || user === void 0 ? void 0 : user.role) === 'Electrical Eng' || (user === null || user === void 0 ? void 0 : user.role) === 'Mechanical Eng' || (user === null || user === void 0 ? void 0 : user.role) === 'Test Engineer';
    };
    const isProgramManager = ()=>{
        return (user === null || user === void 0 ? void 0 : user.role) === 'Program Manager' || (user === null || user === void 0 ? void 0 : user.role) === 'Project Manager';
    };
...
_s5(useRoleAccess, "9ep4vdl3mBfipxjmc+tQCDhw6Ik=", false, function() {
    return [
        useAuth
    ];
});
...
;
const Header = (param)=>{
    let { name, buttonComponent, isSmallText = false } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "mb-5 flex w-full items-center justify-between",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                className: "".concat(isSmallText ? "text-lg" : "text-2xl", " font-semibold dark:text-white"),
                children: name
            }, void 0, false, {
...
;
const Modal = (param)=>{
    let { children, isOpen, onClose, name } = param;
...
"[project]/src/components/ModalFeedback/index.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const ModalFeedback = (param)=>{
    let { isOpen, onClose } = param;
    _s();
    const [createFeedback, { isLoading }] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$state$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCreateFeedbackMutation"])();
    const [formData, setFormData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        type: 'bug',
        title: '',
        description: '',
        priority: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$state$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Priority"].Medium
    });
...
_s(ModalFeedback, "79PUdb/+zmeTMjVvqsHX0zay/7Q=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$state$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCreateFeedbackMutation"]
    ];
});
_c = ModalFeedback;
const __TURBOPACK__default__export__ = ModalFeedback;
var _c;
__turbopack_context__.k.register(_c, "ModalFeedback");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ModalFeedback$2f$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ModalFeedback/index.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
...
const Navbar = ()=>{
    ...
    const safeProfilePictureUrl = sanitizeProfilePictureUrl(user === null || user === void 0 ? void 0 : user.profilePictureUrl);
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    (user === null || user === void 0 ? void 0 : user.id) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        ...
                        title: "View Profile",
                        children: safeProfilePictureUrl ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                src: safeProfilePictureUrl ? "/images/".concat(safeProfilePictureUrl) : '/placeholder.png',
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ModalFeedback$2f$index$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(Navbar, "ctVoxCScBGDyOXbWyqXhlPrJQzk=", false, function() {
    return [
...
const Sidebar = ()=>{
    _s();
    const [showPrograms, setShowPrograms] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [showWorkItems, setShowWorkItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [expandedPrograms, setExpandedPrograms] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    const { data: userParts } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$state$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetPartsByUserQuery"])(userId || "", {
        skip: !userId
    });
    // ✅ Group parts by programId for easy display
    const partsByProgram = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Sidebar.useMemo[partsByProgram]": ()=>{
            if (!userParts) return {};
            return userParts.reduce({
                "Sidebar.useMemo[partsByProgram]": (acc, part)=>{
                    var _acc, _part_programId;
                    ((_acc = acc)[_part_programId = part.programId] || (_acc[_part_programId] = [])).push(part);
                    return acc;
                }
            }["Sidebar.useMemo[partsByProgram]"], {});
        }
    ...
    const filteredPrograms = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Sidebar.useMemo[filteredPrograms]": ()=>{
            if (!programs) return [];
            const programIdsFromParts = new Set((userParts !== null && userParts !== void 0 ? userParts : []).map({
                "Sidebar.useMemo[filteredPrograms]": (part)=>part.programId
            }["Sidebar.useMemo[filteredPrograms]"]));
            if (programIdsFromParts.size > 0) {
                return programs.filter({
                    "Sidebar.useMemo[filteredPrograms]": (program)=>programIdsFromParts.has(program.id)
                }["Sidebar.useMemo[filteredPrograms]"]);
            }
            if (!(user === null || user === void 0 ? void 0 : user.disciplineTeamId)) return [];
            return programs.filter({
                "Sidebar.useMemo[filteredPrograms]": (program)=>{
                    var _program_disciplineTeams;
                    return (_program_disciplineTeams = program.disciplineTeams) === null || _program_disciplineTeams === void 0 ? void 0 : _program_disciplineTeams.some({
                        "Sidebar.useMemo[filteredPrograms]": (dtp)=>dtp.disciplineTeamId === user.disciplineTeamId
                    }["Sidebar.useMemo[filteredPrograms]"]);
                }
            }["Sidebar.useMemo[filteredPrograms]"]);
        }
        ...
        programs,
        userParts,
        user === null || user === void 0 ? void 0 : user.disciplineTeamId
    ]);
    ...
    ========================== */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Sidebar.useEffect": ()=>{
            if (userParts && pathname.startsWith("/parts/")) {
                ...
                const activePart = userParts.find({
                    "Sidebar.useEffect.activePart": (p)=>p.id === partId
                }["Sidebar.useEffect.activePart"]);
                if (activePart) {
                    setExpandedPrograms({
            ...
            children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                    ...
                                    children: (user === null || user === void 0 ? void 0 : user.organizationName) || "Organization"
                                }, void 0, false, {
                                    fileName: "[project]/src/components/Sidebar/index.tsx",
                                    lineNumber: 139,
                                    columnNumber: 25
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                    ...
                    children: [
                        ...
                        (user === null || user === void 0 ? void 0 : user.role) && [
                            ...
                            'Manager',
                            'Program Manager'
                        ].includes(user.role) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SidebarLink, {
                        ...
                        (user === null || user === void 0 ? void 0 : user.role) === 'Admin' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(FeedbackLinkWithBadge, {}, void 0, false, {
                            fileName: "[project]/src/components/Sidebar/index.tsx",
                            lineNumber: 163,
                            columnNumber: 25
                        }, ("TURBOPACK compile-time value", void 0)),
                ...
                filteredPrograms.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                    children: [
                        ...
                        showPrograms && (filteredPrograms === null || filteredPrograms === void 0 ? void 0 : filteredPrograms.map((program)=>{
                            var _partsByProgram_program_id;
                            var _expandedPrograms_program_id;
                            const isOpen = (_expandedPrograms_program_id = expandedPrograms[program.id]) !== null && _expandedPrograms_program_id !== void 0 ? _expandedPrograms_program_id : false;
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: ()=>{
                                    ...
                                    isOpen && ((_partsByProgram_program_id = partsByProgram[program.id]) === null || _partsByProgram_program_id === void 0 ? void 0 : _partsByProgram_program_id.map((part)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SidebarLink, {
                                            ...
                                            label: "".concat(part.partName, " (").concat(part.code, ")"),
...
_s(Sidebar, "NMk+Fc2o6elGHGDl57Inwusp87A=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$state$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetPartsByUserQuery"],
...
const FeedbackLinkWithBadge = ()=>{
    ...
    const { data: countData } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$state$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetUnreadFeedbackCountQuery"])(undefined, {
        pollingInterval: 30000
    });
    const unreadCount = (countData === null || countData === void 0 ? void 0 : countData.count) || 0;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        href: "/feedback",
        className: "w-full",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s2(FeedbackLinkWithBadge, "A2iXYKWWrlkS+eiYDRxPpo7QqAY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$state$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetUnreadFeedbackCountQuery"]
    ];
});
_c2 = FeedbackLinkWithBadge;
const __TURBOPACK__default__export__ = Sidebar;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "Sidebar");
__turbopack_context__.k.register(_c1, "SidebarLink");
__turbopack_context__.k.register(_c2, "FeedbackLinkWithBadge");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
const logError = (error, context)=>{
    ...
    if (error instanceof Error) {
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sentry$2f$core$2f$build$2f$esm$2f$currentScopes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withScope"]((scope)=>{
            if (context) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sentry$2f$core$2f$build$2f$esm$2f$exports$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["captureMessage"](String(error), "error");
    }
};
const getUserFriendlyErrorMessage = function(error) {
...
"[project]/src/components/ErrorBoundary/RouteErrorBoundary.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const RouteErrorFallback = (param)=>{
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "RouteErrorFallback.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$errorHandler$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logError"])(error, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                isDevelopment && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(RouteErrorFallback, "o5ZI+SkIudo7k8HXWSgHRZPlXUg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"]
    ];
});
_c = RouteErrorFallback;
const RouteErrorBoundary = (param)=>{
    let { children, fallback: Fallback = RouteErrorFallback } = param;
    _s1();
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
...
_s1(RouteErrorBoundary, "xbyQPtUVMO7MNj7WjJlpdWqRcTo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"]
    ];
});
_c1 = RouteErrorBoundary;
var _c, _c1;
__turbopack_context__.k.register(_c, "RouteErrorFallback");
__turbopack_context__.k.register(_c1, "RouteErrorBoundary");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$redux$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/redux.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/contexts/AuthContext.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ErrorBoundary$2f$RouteErrorBoundary$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ErrorBoundary/RouteErrorBoundary.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
"use client";
;
...
const DashboardWrapper = (param)=>{
    ...
    const [isOnboarding, setIsOnboarding] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$redux$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ErrorBoundary$2f$RouteErrorBoundary$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RouteErrorBoundary"], {
            ...
            isAuthenticated ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(DashboardLayout, {
                children: children
            }, void 0, false, {
                fileName: "[project]/src/app/dashboardWrapper.tsx",
                lineNumber: 92,
...
_s1(DashboardWrapper, "D70SB3tcuV5Z2+iqp+mwhB5YoFo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
...
"[project]/src/components/ErrorBoundary/index.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ErrorBoundary extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Component"] {
    ...
    componentDidUpdate(prevProps) {
        ...
        if (this.props.resetKeys && this.props.resetOnPropsChange) {
            const hasResetKeyChanged = this.props.resetKeys.some((key, index)=>{
                ...
                return key !== ((_prevProps_resetKeys = prevProps.resetKeys) === null || _prevProps_resetKeys === void 0 ? void 0 : _prevProps_resetKeys[index]);
            });
    ...
    constructor(props){
        super(props), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "resetErrorBoundary", ()=>{
            this.setState({
                hasError: false,
                error: null,
                errorInfo: null
...
const ErrorFallback = (param)=>{
    let { error, errorInfo, onReset } = param;
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const isDevelopment = ("TURBOPACK compile-time value", "development") === "development";
    const handleGoHome = ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                isDevelopment && error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("pre", {
                            ...
                            children: [
                                error.toString(),
                                (errorInfo === null || errorInfo === void 0 ? void 0 : errorInfo.componentStack) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                    children: [
                                        "\n\nComponent Stack:",
                ...
                !isDevelopment && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("code", {
                            ...
                            children: (error === null || error === void 0 ? void 0 : error.name) || "UNKNOWN"
                        }, void 0, false, {
                            fileName: "[project]/src/components/ErrorBoundary/index.tsx",
                            lineNumber: 192,
                            columnNumber: 13
...
_s(ErrorFallback, "fN7XvhJ+p5oE6+Xlo0NJmXpxjC8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
const showToast = {
   ...
   */ error: function(message) {
        let duration = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 5000;
...
const showApiError = function(error) {
    let defaultMessage = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "An error occurred";
    ...
    const message = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$errorHandler$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleApiError"])(error, defaultMessage);
    showToast.error(message);
};
...
"[project]/src/lib/globalErrorHandler.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const setupGlobalErrorHandlers = ()=>{
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        ...
        window.onerror = (message, source, lineno, colno, error)=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$errorHandler$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["logError"])(errorObj, {
            ...
            if (error && !error.message.includes("Script error")) {
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"].error("An unexpected error occurred. Please refresh the page if the problem persists.");
            }
        ...
        window.onunhandledrejection = (event)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["showToast"].error("An operation failed unexpectedly. Please try again or refresh the page.");
...
"[project]/src/components/ErrorBoundary/GlobalErrorHandler.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$globalErrorHandler$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/globalErrorHandler.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
;
const GlobalErrorHandlerSetup = ()=>{
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlobalErrorHandlerSetup.useEffect": ()=>{
            // Setup global error handlers
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$globalErrorHandler$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setupGlobalErrorHandlers"])();
            // Cleanup on unmount
            return ({
                "GlobalErrorHandlerSetup.useEffect": ()=>{
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$globalErrorHandler$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeGlobalErrorHandlers"])();
                }
            })["GlobalErrorHandlerSetup.useEffect"];
        }
    }["GlobalErrorHandlerSetup.useEffect"], []);
...
_s(GlobalErrorHandlerSetup, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = GlobalErrorHandlerSetup;
var _c;
__turbopack_context__.k.register(_c, "GlobalErrorHandlerSetup");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_f7022872._.js.map