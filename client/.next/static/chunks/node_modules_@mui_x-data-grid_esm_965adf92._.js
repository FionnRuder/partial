...
function findGridHeaderFilter(api, field) {
    const headers = api.columnHeadersContainerRef.current;
    return headers.querySelector(":scope > .".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$data$2d$grid$2f$esm$2f$constants$2f$gridClasses$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gridClasses"].headerFilterRow, ' > [data-field="').concat(escapeOperandAttributeSelector(field), '"]'));
}
...
const shouldCellShowRightBorder = (pinnedPosition, indexInSection, sectionLength, showCellVerticalBorderRootProp, gridHasFiller, pinnedColumnsSectionSeparatorRootProp)=>{
    ...
    if ((pinnedColumnsSectionSeparatorRootProp === null || pinnedColumnsSectionSeparatorRootProp === void 0 ? void 0 : pinnedColumnsSectionSeparatorRootProp.startsWith('border')) && pinnedPosition === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$data$2d$grid$2f$esm$2f$internals$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PinnedColumnPosition"].LEFT && isSectionLastCell) {
        return true;
    }
...
function transformTheme(t) {
    ...
    const backgroundBase = (_dataGridPalette_bg = dataGridPalette === null || dataGridPalette === void 0 ? void 0 : dataGridPalette.bg) !== null && _dataGridPalette_bg !== void 0 ? _dataGridPalette_bg : t.palette.mode === 'dark' ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$data$2d$grid$2f$esm$2f$components$2f$containers$2f$GridRootStyles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["colorMixIfSupported"])("color-mix(in srgb, ".concat(paperColor, " 95%, #fff)"), paperColor) : paperColor;
    ...
    const backgroundOverlay = t.palette.mode === 'dark' ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$data$2d$grid$2f$esm$2f$components$2f$containers$2f$GridRootStyles$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["colorMixIfSupported"])("color-mix(in srgb, ".concat(paperColor, " 90%, #fff)"), paperColor) : paperColor;
