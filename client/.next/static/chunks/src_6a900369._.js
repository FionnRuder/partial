...
const AuthScreen = (param)=>{
    let { onBack, onNext, initialMode = "signup" } = param;
    _s();
...
_s(AuthScreen, "XwEcw6PAfGJX4nP2sUMGibmhL9Q=", false, function() {
    return [
...
_s1(RoleSelectionScreen, "QlSmIUmoA6lEvr8Rpg28G/bMXvA=");
...
_s2(OrganizationNameScreen, "s5pBdVgDDQwm3poo+5Qyq1/ZI68=");
...
_s3(ProfileCompletionScreen, "PoM8++42nckTHB0ivWySstW5TTE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
_s4(ProgramSetupScreen, "IZJuVTYtu0Au5M6ec3YGy+xd9pg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$state$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetProgramsQuery"],
...
_s5(MilestoneSetupScreen, "EetWv79kV5KRJL0JSsf2omUBH+U=", false, function() {
    return [
...
_s6(PartSetupScreen, "oHPPWFEAg/GMP0VQTHbYFeZ7gCQ=", false, function() {
    return [
...
const OnboardingPage = ()=>{
    ...
    const createUserInDatabase = async (role, orgName)=>{
        ...
        try {
            ...
            let userPhoneNumber = '';
            try {
                const sessionCheck = await fetch("".concat(apiBaseUrl, "/auth/me"), {
                    method: 'GET',
                    credentials: 'include',
                    signal: controller.signal
                });
...
_s7(OnboardingPage, "9KJo1O2GF1Xr3wKZkEi66odh0fY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=src_6a900369._.js.map