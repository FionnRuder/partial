...
function checkHasPath(url) {
    try {
        ...
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$error$2d$RtKwr3Pu$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__t__as__BetterAuthError$3e$__["BetterAuthError"]("Invalid base URL: ".concat(url, ". Please provide a valid base URL."));
    }
}
function assertHasProtocol(url) {
    try {
        const parsedUrl = new URL(url);
        if (parsedUrl.protocol !== "http:" && parsedUrl.protocol !== "https:") throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$error$2d$RtKwr3Pu$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__t__as__BetterAuthError$3e$__["BetterAuthError"]("Invalid base URL: ".concat(url, ". URL must include 'http://' or 'https://'"));
    } catch (error) {
        ...
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$error$2d$RtKwr3Pu$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__t__as__BetterAuthError$3e$__["BetterAuthError"]("Invalid base URL: ".concat(url, ". Please provide a valid base URL."), String(error));
    }
}
...
const getClientConfig = (options, loadEnv)=>{
    ...
    const { onSuccess: _onSuccess, onError: _onError, onRequest: _onRequest, onResponse: _onResponse, ...restOfFetchOptions } = (options === null || options === void 0 ? void 0 : options.fetchOptions) || {};
...
function getAtomKey(str) {
    return "use".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$utils$2d$NloIXYE0$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__t__as__capitalizeFirstLetter$3e$__["capitalizeFirstLetter"])(str));
}
...
var getAuthHeader = async (options)=>{
    ...
    if (options == null ? void 0 : options.auth) {
        if (options.auth.type === "Bearer") {
            ...
            headers["authorization"] = "".concat(prefix != null ? prefix : "", " ").concat(value);
        }
    }
    return headers;
};
...
class m extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Component"] {
    ...
    resetErrorBoundary() {
        ...
        e !== null && ((_this_props_onReset = (_this_props = this.props).onReset) === null || _this_props_onReset === void 0 ? void 0 : _this_props_onReset.call(_this_props, {
            args: t,
    ...
    componentDidCatch(t, e) {
        ...
        (_this_props_onError = (_this_props = this.props).onError) === null || _this_props_onError === void 0 ? void 0 : _this_props_onError.call(_this_props, t, e);
    }
    componentDidUpdate(t, e) {
        var _this_props_onReset, _this_props;
        const { didCatch: o } = this.state, { resetKeys: n } = this.props;
        o && e.error !== null && C(t.resetKeys, n) && ((_this_props_onReset = (_this_props = this.props).onReset) === null || _this_props_onReset === void 0 ? void 0 : _this_props_onReset.call(_this_props, {
            next: n,
            prev: t.resetKeys,
            reason: "keys"
        }), this.setState(c));
...
function S() {
    ...
    w(r);
    const { error: t, resetErrorBoundary: e } = r, [o, n] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        error: null,
        hasError: !1
...
function k(r, t) {
    const e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])((n, s)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"])(m, t, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"])(r, {
            ...n,
            ref: s
        }))), o = r.displayName || r.name || "Unknown";
    return e.displayName = "withErrorBoundary(".concat(o, ")"), e;
}
;
...
//# sourceMappingURL=node_modules_d51fe688._.js.map