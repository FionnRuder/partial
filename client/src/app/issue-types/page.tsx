  ...
  if (isLoading) {
    return (
      <div className="max-w-full p-8">
        <Header name="Issue Types" />
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Manage issue types for your organization</p>
      ...
      <div className="max-w-full p-8">
        ...
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
          <p className="text-red-800 dark:text-red-200">
            Error loading issue types. You may not have permission to view types.
          </p>
        </div>
      </div>
    );
    ...
    <div className="max-w-full p-8">
      <div className="mb-6">
        <div className="flex justify-between items-start mb-2">
          <div>
            <Header name="Issue Types" />
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Manage issue types for your organization</p>
          </div>
          <button
      ...
      {types && types.length === 0 ? (
        <div className="bg-white dark:bg-dark-secondary rounded-lg shadow p-8 text-center">
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            No issue types found. Create your first type to get started.
          </p>
          <button
            onClick={() => setShowCreateModal(true)}
